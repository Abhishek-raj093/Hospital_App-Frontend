...
const Login = () => {
  ...
  const requestOtp = async (e) => {
    ...
    setOtpFlag(true);
    axios.post("https://hospital-app-backend-5vhe.onrender.com/sendotp", { email: registrationData.email })
      .then((response) => {
        setOtpFlag(true);
  ...
  const loginUsingPassword = async (e) => {
    ...
    axios.post("https://hospital-app-backend-5vhe.onrender.com/login", registrationData).
      then(response => {
  ...
  const loginUsingOTP = async (e) => {
    ...
    axios.post("https://hospital-app-backend-5vhe.onrender.com/verifyOtp", registrationData)
      .then((response) => {
        if (response.data.userData.role === "admin") {
          navigate(`/admin/admindetails`);
        }
